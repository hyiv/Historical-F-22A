...
BGROUND.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
...
FCSP.init_rot 			    = {0, 0, 0}
FCSP.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
...
FCSIND.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
...
FCS_RR.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_RR"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_RR.controllers			=   {
...
FCS_LR.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_LR"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_LR.controllers			=   {
                                    {"opacity_using_parameter",0},
                                    {"parameter_in_range",1,0.9,1.1},
                                    {"move_left_right_using_parameter",2,0.01,0},
...
FCS_LA.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_LA"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_LA.controllers			=   {
                                    {"opacity_using_parameter",0},
                                    {"parameter_in_range",1,0.9,1.1},
...
FCS_RA.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_RA"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_RA.controllers			=   {
                                    {"opacity_using_parameter",0},
                                    {"parameter_in_range",1,0.9,1.1},
                                    {"move_left_right_using_parameter",2,0.01,0}}--MENU PAGE = 1
...
FCS_LE.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_LE"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_LE.controllers			=   {
                                    {"opacity_using_parameter",0},
                                    {"parameter_in_range",1,0.9,1.1},
                                    {"move_left_right_using_parameter",2,0.01,0}}--MENU PAGE = 1
...
FCS_RE.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_RE"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_RE.controllers			=   {
                                   {"opacity_using_parameter",0},
                                   {"parameter_in_range",1,0.9,1.1},
                                   {"move_left_right_using_parameter",2,0.01,0}}--MENU PAGE = 1
...
FCS_LF.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_LF"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_LF.controllers			=   {
                                    {"opacity_using_parameter",0},
                                    {"parameter_in_range",1,0.9,1.1},
...
FCS_RF.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_RF"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
FCS_RF.controllers			=   {
                                    {"opacity_using_parameter",0},
                                    {"parameter_in_range",1,0.9,1.1},
                                    {"move_left_right_using_parameter",2,0.0190,0}}--MENU PAGE = 1
...
FCS_L_LEF.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_LEF"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
...
FCS_R_LEF.element_params 		= {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_LEF"}--this may not be bneeded check when more pages done for backlight on page 7 RWR fc3 bs
...
MENU_CHK_TEXT.element_params 	    = {"MFD_OPACITY","RMFD_FCS_PAGE"}
...
MENU_TEXT1.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE"}
...
MENU_TEXT2.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE"}
...
MENU_TEXT3.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE"}
...
-- AUTO_FCS.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_AUTO"}
...
-- ORIDE_FCS.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_AUTO"}
...
-- G_FCS.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE"}
...
-- A_FCS.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE"}
...
-- INFO_FCS_AUTO.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_MODE"}
...
-- INFO_FCS_AUTO.init_pos 			        = {0, -0.05, 0}
-- INFO_FCS_AUTO.init_rot 			        = {0, 0, 0}
-- INFO_FCS_AUTO.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE","HUD_MODE","FCS_MODE"}
...
-- INFO_FCS_ORIDE.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_MODE"}
...
-- INFO_FCS_G.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_MODE"}
...
-- INFO_FCS_A.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE","FCS_MODE"}
...
AOA_NUM.element_params		= {"MFD_OPACITY","AOA","RMFD_FCS_PAGE"}
...
AOA_TXT.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE"}
...
G_NUM.level				= 2
G_NUM.element_params		= {"MFD_OPACITY","GFORCE","RMFD_FCS_PAGE"}
...
G_TXT.element_params 	        = {"MFD_OPACITY","RMFD_FCS_PAGE"}
