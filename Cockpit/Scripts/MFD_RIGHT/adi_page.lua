...
BGROUND.element_params 		= {"MFD_OPACITY","RMFD_ADI_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
ADIUP.element_params 	  = {"RMFD_ADI_PAGE","ADIROLL","ADIPITCH","MFD_OPACITY"} --HOPE THIS WORKS G_OP_BACK
ADIUP.controllers		  = {
...
ADIDN.element_params 	  = {"RMFD_ADI_PAGE","ADIROLL","ADIPITCH","MFD_OPACITY"} --HOPE THIS WORKS G_OP_BACK
ADIDN.controllers		  = {
							{"parameter_in_range",0,0.9,1.1},
							{"rotate_using_parameter",1,1,0},
							{"move_up_down_using_parameter",2,0.182,0},--needs to be checked with a ladder scale
...
ADILINEM.element_params 	        = {"RMFD_ADI_PAGE","ADIROLL","ADIPITCH",} --HOPE THIS WORKS G_OP_BACK
...
ADILINE.element_params 	        = {"RMFD_ADI_PAGE","ADIROLL","ADIPITCH","MFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
ADILINE.controllers		                = {
							                {"parameter_in_range",0,0.9,1.1},
							                {"rotate_using_parameter",1,1,0},
							                {"move_up_down_using_parameter",2,-0.182,0},--needs to be checked with a ladder scale
...
ADILADDERTOP.element_params 	  = {"RMFD_ADI_PAGE","ADIROLL","ADIPITCH","MFD_OPACITY"} --HOPE THIS WORKS G_OP_BACK
...
ADILADDERBOT.element_params 	  = {"RMFD_ADI_PAGE","ADIROLL","ADIPITCH","MFD_OPACITY"} --HOPE THIS WORKS G_OP_BACK
...
ADIVVM.element_params 	        = {"RMFD_ADI_PAGE"} --HOPE THIS WORKS G_OP_BACK
ADIVVM.controllers		                = {
							                {"parameter_in_range",0,0.9,1.1},
							                --{"rotate_using_parameter",1,1,0},
...
ADIVV.element_params 	        = {"RMFD_ADI_PAGE","MFD_OPACITY",} --HOPE THIS WORKS G_OP_BACK
ADIVV.controllers		                = {
							                {"parameter_in_range",0,0.9,1.1},
							                --{"rotate_using_parameter",1,1,0},
							               -- {"move_up_down_using_parameter",2,-0.037,0},--needs to be checked with a ladder scale
...
ADIILS_H.element_params 		= {"MFD_OPACITY","RMFD_ADI_PAGE","ILS_HORIZON","ILSN_VIS"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
ADIILS_V.element_params 		= {"MFD_OPACITY","RMFD_ADI_PAGE","ILS_VERT","ILSN_VIS"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
ADIMASK.element_params 		= {"RMFD_ADI_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
ADIMASKGLOW.element_params 		= {"MFD_OPACITY","RMFD_ADI_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
SLIPBOX.element_params 		= {"MFD_OPACITY","RMFD_ADI_PAGE","SLIP"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
SLIPBOX.controllers			= {
...
ADIMASKSLIP.element_params 		= {"RMFD_ADI_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
ADIMASKSLIPGLOW.element_params 		= {"RMFD_ADI_PAGE","MFD_OPACITY",}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
BOXES.element_params 		= {"MFD_OPACITY","RMFD_ADI_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
RING.init_rot 			= {0, 0, 0}
RING.element_params 		= {"MFD_OPACITY","RMFD_ADI_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
IAS.level				= 11
IAS.element_params		= {"MFD_OPACITY","IAS","RMFD_ADI_PAGE"}
IAS.formats				= {"%.0f"} --{"%.0f"}
...
BAROALT.level				= 11
BAROALT.element_params		= {"MFD_OPACITY","BAROALT","RMFD_ADI_PAGE"}
...
FPM.level				= 11
FPM.element_params		= {"MFD_OPACITY","vv","RMFD_ADI_PAGE"}
FPM.formats				= {"%.0f"} --{"%.0f"}
...
NAV.level				= 11
NAV.element_params		= {"MFD_OPACITY","NAV","RMFD_ADI_PAGE"}
...
MENU_CHK_TEXT.element_params 	    = {"MFD_OPACITY","RMFD_ADI_PAGE"}
...
HSI_TEXT.element_params 	    = {"MFD_OPACITY","RMFD_ADI_PAGE"}
