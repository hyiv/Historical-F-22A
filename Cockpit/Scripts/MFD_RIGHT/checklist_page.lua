...
BGROUND.element_params 		= {"MFD_OPACITY","RMFD_CHECKLIST_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
COLD.init_rot 			= {0, 0, 0}
COLD.element_params 		= {"MFD_OPACITY","RMFD_CHECKLIST_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
MENU_CHK_TEXT.element_params 	    = {"MFD_OPACITY","RMFD_CHECKLIST_PAGE"}
...
MENU_TEXT1.element_params 	        = {"MFD_OPACITY","RMFD_CHECKLIST_PAGE"}
...
MENU_TEXT2.element_params 	        = {"MFD_OPACITY","RMFD_CHECKLIST_PAGE"}
...
MENU_TEXT3.element_params 	        = {"MFD_OPACITY","RMFD_CHECKLIST_PAGE"}
...
-- CHECKLISTPLACEHOLD.element_params 	        = {"MFD_OPACITY","RMFD_CHECKLIST_PAGE"}
