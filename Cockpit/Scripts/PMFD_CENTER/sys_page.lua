...
local ClippingPlaneSize = 125 --Clipping Masks
local ClippingWidth 	= 125--Clipping Masks
...
PH_TEXT.element_params 	        = {"MFD_OPACITY","PMFD_SYS_PAGE"}
...
MENUTEXT.level 				    = 2
MENUTEXT.init_pos 			    = {-72,-114, 0}
MENUTEXT.init_rot 			    = {0, 0, 0}
MENUTEXT.element_params 	    = {"MFD_OPACITY","PMFD_SYS_PAGE"}
