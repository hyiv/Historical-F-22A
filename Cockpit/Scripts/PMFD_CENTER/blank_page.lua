...
BGROUND.element_params 		= {"MFD_OPACITY","PMFD_BLANK_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
BLOG.init_rot 			= {0, 0, 0}
BLOG.element_params 		= {"MFD_OPACITY","PMFD_BLANK_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
