...
BGROUND.element_params 		= {"MFD_OPACITY","CMFD_MENU_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
ADITEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
ADITEXT.controllers		        =   {
...
HSITEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
HSITEXT.controllers		        =   {
                                            {"opacity_using_parameter",0},
                                            {"parameter_in_range",1,0.9,1.1},--MENU PAGE = 0
						                }
...
ENGTEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
ENGTEXT.controllers		        =   {
                                            {"opacity_using_parameter",0},
                                            {"parameter_in_range",1,0.9,1.1},--MENU PAGE = 0
						                }
...
FCSTEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
FCSTEXT.controllers		        =   {
                                            {"opacity_using_parameter",0},
                                            {"parameter_in_range",1,0.9,1.1},--MENU PAGE = 0
						                }
...
FUELTEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
...
BAYTEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
BAYTEXT.controllers		        =   {
                                            {"opacity_using_parameter",0},
                                            {"parameter_in_range",1,0.9,1.1},--MENU PAGE = 0
						                }
...
CHKTEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
CHKTEXT.controllers		        =   {
                                            {"opacity_using_parameter",0},
                                            {"parameter_in_range",1,0.9,1.1},--MENU PAGE = 0
						                }
